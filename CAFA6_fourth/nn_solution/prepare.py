...
if __name__ == '__main__':
    ...
    CCOProt = set(train_terms[train_terms['aspect']=='C']['EntryID'].unique())
    MFOProt = set(train_terms[train_terms['aspect']=='F']['EntryID'].unique())
    BPOProt = set(train_terms[train_terms['aspect']=='P']['EntryID'].unique())
